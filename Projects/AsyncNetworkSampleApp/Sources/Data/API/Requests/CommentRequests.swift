...
//    includeRetryTests: true
//)
struct GetCommentByIdRequest: APIRequest {
    var baseURLString: String

    var path: String

    var method: AsyncNetworkCore.HTTPMethod

//    @PathParameter var id: Int
//    @QueryParameter var includeUser: Bool? = false
//    @HeaderField(key: .contentType) var contentType: String? = "application/json"
//    @CustomHeader("application/json") var customContentType: String? = "application/json"
}
