...
struct NotificationDTOTests {
    ...
    struct TextNotificationDTOTests {
        @Test("TextNotificationDTO.random()이 유효한 데이터를 생성하는지 확인")
        func textNotificationDTOMock() {
            // When
            let mock = TextNotificationDTO.random()
        ...
        @Test("TextNotificationDTO.random()이 매번 다른 값을 생성하는지 확인")
        func textNotificationDTOMockRandomness() {
            // When
            let mock1 = TextNotificationDTO.random()
            let mock2 = TextNotificationDTO.random()

            // Then - 랜덤이므로 값이 달라야 함
            #expect(mock1.id != mock2.id || mock1.title != mock2.title)
        }

        @Test("TextNotificationDTO.randomArray()가 여러 개의 Mock을 생성하는지 확인")
        func textNotificationDTOMockArray() {
            // When
            let mocks = TextNotificationDTO.randomArray(count: 10)
        ...
        @Test("TextNotificationDTO.randomArray()가 기본 개수로 생성하는지 확인")
        func textNotificationDTOMockArrayDefaultCount() {
            // When ()
            let mocks = TextNotificationDTO.randomArray()

            // Then
            #expect(mocks.count == 5)
        }

        @Test("TextNotificationDTO.fixture()가 커스텀 데이터를 생성하는지 확인")
        func textNotificationDTOBuilder() {
            ...
            // When
            let custom = TextNotificationDTO.fixture()
                .with(id: "text-001")
        ...
        @Test("TextNotificationDTO.fixture()가 일부만 커스터마이징하는지 확인")
        func textNotificationDTOBuilderPartial() {
            // When - title만 변경
            let partial = TextNotificationDTO.fixture()
        ...
        func textNotificationDTOCodable() throws {
            ...
            let original = TextNotificationDTO.fixture()
                .with(id: "text-001")
                .with(type: 1)
                .with(title: "Test")
        ...
        func textNotificationDTOEquatable() {
            // Given
            let dto1 = TextNotificationDTO.fixture()
                .with(id: "text-001")
                .with(type: 1)
                .with(title: "Same")
                .with(content: "Same")
            ...
            let dto2 = TextNotificationDTO.fixture()
                .with(id: "text-001")
                .with(type: 1)
                .with(title: "Same")
                .with(content: "Same")
    ...
    struct ImageNotificationDTOTests {
        @Test("ImageNotificationDTO.random()이 유효한 데이터를 생성하는지 확인")
        func imageNotificationDTOMock() {
            // When
            let mock = ImageNotificationDTO.random()
        ...
        @Test("ImageNotificationDTO.fixture()로 커스텀 이미지 URL 설정")
        func imageNotificationDTOBuilderCustom() {
            ...
            // When
            let custom = ImageNotificationDTO.fixture()
                .with(id: "image-001")
        ...
        func imageNotificationDTOCodable() throws {
            // Given
            let original = ImageNotificationDTO.fixture()
                .with(id: "image-001")
                .with(type: 2)
                .with(title: "Image")
    ...
    struct ActionNotificationDTOTests {
        @Test("ActionNotificationDTO.random()이 유효한 데이터를 생성하는지 확인")
        func actionNotificationDTOMock() {
            // When
            let mock = ActionNotificationDTO.random()
        ...
        @Test("ActionNotificationDTO.fixture()로 특정 액션 타입 설정")
        func actionNotificationDTOBuilderAction() {
            ...
            // When
            let custom = ActionNotificationDTO.fixture()
                .with(id: "action-001")
        ...
        func actionNotificationDTOCodable() throws {
            // Given
            let original = ActionNotificationDTO.fixture()
                .with(id: "action-001")
                .with(type: 3)
                .with(title: "Action")
    ...
    struct NotificationDTOUnionTypeTests {
        @Test("NotificationDTO.random()이 유효한 케이스를 생성하는지 확인")
        func notificationDTOMock() throws {
            // When
            let mock = NotificationDTO.random()
        ...
        @Test("NotificationDTO.randomArray()가 여러 개의 Mock을 생성하는지 확인")
        func notificationDTOMockArray() throws {
            // When
            let mocks = NotificationDTO.randomArray(count: 10)
        ...
        func notificationDTOEncode() throws {
            // Given - 각 케이스별 DTO 생성
            let textDTO = TextNotificationDTO.fixture()
                .with(id: "text-001")
                .with(type: 1)
                .with(title: "Text")
                .with(content: "Content")
        ...
        func notificationDTOEquatable() {
            ...
            let textDTO1 = TextNotificationDTO.fixture()
                .with(id: "text-001")
                .with(type: 1)
                .with(title: "Same")
                .with(content: "Same")
            ...
            let textDTO2 = TextNotificationDTO.fixture()
                .with(id: "text-001")
                .with(type: 1)
                .with(title: "Same")
                .with(content: "Same")
            ...
            // Given - 다른 케이스
            let imageDTO = ImageNotificationDTO.fixture()
                .with(id: "image-001")
                .with(type: 2)
                .with(title: "Image")
                .with(imageURL: "https://example.com/image.jpg")
        ...
        func notificationDTOUnreadFiltering() {
            // Given
            let read = TextNotificationDTO.fixture()
                .with(id: "text-001")
                .with(type: 1)
                .with(title: "Read")
                .with(content: "Content")
            ...
            let unread = TextNotificationDTO.fixture()
                .with(id: "text-002")
                .with(type: 1)
                .with(title: "Unread")
                .with(content: "Content")
