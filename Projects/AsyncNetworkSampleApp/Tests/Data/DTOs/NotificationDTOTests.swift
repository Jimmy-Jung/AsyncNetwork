...
struct NotificationDTOTests {
    ...
    func decodeTextNotification() throws {
        let json = """
        {
            "id": "notif_123",
            "type": 1,
    ...
    func decodeImageNotification() throws {
        let json = """
        {
            "id": "notif_456",
            "type": 2,
    ...
    func decodeActionNotification() throws {
        let json = """
        {
            "id": "notif_789",
            "type": 3,
    ...
    func encodeTextNotification() throws {
    ...
    func encodeImageNotification() throws {
        ...
        // JSON 필드 존재 여부 확인 (슬래시 이스케이프 고려)
        #expect(json.contains("\"id\":\"notif_002\""))
        #expect(json.contains("\"type\":2"))
        #expect(json.contains("\"imageURL\""))
        // JSON 인코더는 슬래시를 \/ 로 이스케이프할 수 있음
        #expect(json.contains("example.com") && json.contains("image.jpg"))
        #expect(json.contains("\"thumbnail\""))
        #expect(json.contains("thumb.jpg"))
    }
