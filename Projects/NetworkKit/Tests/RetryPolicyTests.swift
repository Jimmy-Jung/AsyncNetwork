...
//    }
//
//    // MARK: - QubeServerError Retry Tests
//
//    @Test("재시도 가능한 QubeServerError에 대해 재시도 결정")
//    func shouldRetryRetryableQubeServerError() {
//        // Given
...
//    }
//
//    @Test("재시도 불가능한 QubeServerError에 대해 재시도 중단")
//    func shouldNotRetryNonRetryableQubeServerError() {
//        // Given
...
//    }
//
//    // MARK: - MoyaError Retry Tests
//
//    @Test("5xx MoyaError에 대해 재시도 결정")
//    func shouldRetry5xxMoyaError() {
//        // Given
//        let response = createMockResponse(statusCode: 500)
//        let moyaError = MoyaError.statusCode(response)
//
//        // When
//        let decision = defaultPolicy.shouldRetry(error: moyaError, attempt: 1)
//
//        // Then
//        switch decision {
//        case .retry(let delay):
//            #expect(delay > 0)
//        case .stop, .retryImmediately:
//            #expect(Bool(false), "5xx 에러는 재시도되어야 함")
//        }
//    }
//
//    @Test("4xx MoyaError에 대해 재시도 중단")
//    func shouldNotRetry4xxMoyaError() {
//        // Given
...
//        switch decision {
//        case .stop:
//            #expect(Bool(true), "4xx 에러는 재시도되지 않아야 함")
//        case .retry, .retryImmediately:
//            #expect(Bool(false), "4xx 에러는 재시도되지 않아야 함")
//        }
//    }
//
//    @Test("MoyaError.underlying URLError에 대해 재시도 결정")
//    func shouldRetryMoyaErrorUnderlyingURLError() {
//        // Given
...
//            #expect(delay > 0)
//        case .stop, .retryImmediately:
//            #expect(Bool(false), "URLError는 재시도되어야 함")
//        }
//    }
//
...
//// MARK: - Helper Methods
//
// private extension RetryPolicyTests {
//    /// Mock Response 생성
