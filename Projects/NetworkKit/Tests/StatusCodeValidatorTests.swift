...
//
//        // When & Then
//        let validatedResponse = try #require(defaultValidator.validate(response))
...
//
//        // When & Then
//        let validatedResponse = try #require(lenientValidator.validate(response))
...
//            let validatedResponse = try #require(strictValidator.validate(response))
...
//        // When & Then - 유효한 상태 코드들
//        for response in validResponses {
//            let validatedResponse = try #require(customValidator.validate(response))
//            #expect(validatedResponse.statusCode == response.statusCode)
//        }
//
//        // When & Then - 무효한 상태 코드
...
//    /// Mock Response 생성
//    func createMockResponse(statusCode: Int, data: Data = "test".data(using: .utf8)!) -> Response {
