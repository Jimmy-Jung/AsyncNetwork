...
//
//  이 스크립트는 프로젝트의 모든 @DocumentedType 타입을 스캔하여
//  자동으로 등록하는 Swift 코드를 생성합니다.
//
...
/// @DocumentedType이 적용된 타입을 스캔하는 클래스
struct TypeScanner {
...
struct CodeGenerator {
    ...
    func generateRegistrationCode(types: [String]) -> String {
        ...
        extension \(targetName) {
            ...
            ///
            /// 이 메서드는 빌드 시 자동 생성되었습니다.
            /// 타입을 추가/삭제하면 다음 빌드에서 자동으로 업데이트됩니다.
            ///
            /// - Note: 생성된 타입 수: \(types.count)개
